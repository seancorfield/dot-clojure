...
**The default Clojure version in use here is 1.13.0-alpha5!**
...
* `:1.13` -- Clojure 1.13.0-alpha5 -- see [changes to Clojure in the 1.13 Alpha releases](https://clojure.org/releases/devchangelog#_release_1_13_x)
