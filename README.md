...
* `:1.12` -- Clojure 1.12.0-alpha9 -- see [changes to Clojure in prerelease versions of 1.12.0](https://clojure.org/releases/devchangelog)
* `:1.11` -- Clojure 1.11.2 -- see [changes to Clojure in version 1.11.1](https://github.com/clojure/clojure/blob/master/changes.md)
