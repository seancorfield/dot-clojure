...
**The default Clojure version in use here is 1.13.0-alpha3!**
...
* `:1.13` -- Clojure 1.13.0-alpha3 -- see [changes to Clojure in version 1.13.0-alpha1](https://clojure.org/news/2026/07/02/clojure-1-13-alpha1)
